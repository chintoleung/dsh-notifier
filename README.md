...
Package metadata: `dsh-notifier@0.9.6` · 1544 automated contract tests (1544 pass) · MIT licensed.
...
test/                 1544 tests (1544 pass) in the 0.9.6 release line; historical 0.8.6 package carried 909 tests.
```
...
> For active development and contributor work, use the private dev repository `THEWOLFWALKER/dsh-notifier-dev`. This public mirror is a release/source snapshot only — do not develop here.

```bash
npm test          # 0.9.6 release line: 1544 (1544 pass)
```
